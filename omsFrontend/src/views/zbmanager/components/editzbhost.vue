<template>
      <el-form :model="rowdata" ref="rowdata" label-width="100px">
        <el-form-item label="主机名" prop="hostnames">
          <el-input v-model="rowdata.host"></el-input>
        </el-form-item>
        <el-form-item label="主机组" prop="hostgroups">
          <sesect-groups :selectdata="rowdata.groups" @getDatas="getGroups"></sesect-groups>
        </el-form-item>
        <el-form-item label="模板" prop="templates">
          <sesect-temps :selectdata="rowdata.parentTemplates" @getDatas="getTemps"></sesect-temps>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="submitForm('rowdata')">立即创建</el-button>
        </el-form-item>
      </el-form>
</template>
<script>
